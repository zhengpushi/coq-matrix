...
(** vfoldl, vfoldr, vfoldlrev，三种折叠方法的比较 *)
...
Module Cmp_diff_method_of_vfold.
  ...
  *)
  ...
  Print fold_right.
  (* 从最后一个元素开始折叠，递归时 f 函数无法执行，将操作数压栈 *)
  ...
  *)
  ...
  Print vfoldlrev.
  (* 从第一个元素开始折叠，递归时 f 函数无法执行，将操作数压栈 *)
...
Extraction "mat1.ml" mat_build_spec mat_build mat_mult
  ex_vec1 ex_vec3 ex_mat22 ex_mat33  (* 手动构造的，将来会被取代 *)
  of_list to_list   (* 转换函数 *)
  v2 f1 f2_1 f2_2 f3.
